...
sampleTime = 60  # in minutes, connot be greater than one hour
numberOfHours = 24  # can be multi day
maxTime = numberOfHours * 60 / sampleTime  # number of sampleTime minute intervals
# SUPPLY DEMAND
S = data.calculateSupply(sampleTime, numberOfHours, 9 * 285)

# HOME LIST OF LOADS
# loads.dryerMachine,
home = [
    loads.washingMachine]  # , loads.dryerMachine, loads.lightsEarly, loads.lightsLate, loads.fridge, loads.kettle, loads.coffeeMaker] #, loads.airConditioner] #, loads.coffeeMaker,
