...
def chargeDischargeCost(changeEnergy, MaxDeltaBatt):
    # positive charge, negative discharge
    # add a tiny expense based on the charge/discharge rate
    return (0.0 * abs(changeEnergy * 1.0) / MaxDeltaBatt)


def chargedValue(newBattIndex, MinBattery, MaxBattery):
    # value of having the battery charged
    if newBattIndex < MinBattery:
        return -1000
    return 0.0 * newBattIndex / MaxBattery


# SEE https://www.powerstream.ca/customers/rates-support-programs/time-of-use-pricing.html
