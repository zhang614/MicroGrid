...
sampleTime = 10 #in minutes, connot be greater than one hour
numberOfHours = 5 #can be multi day
...
##    
for example in [int(batt.maxEnergy*.6)]: #range(batteryAhMin,batteryAh+1-batteryAh/6,batteryAh/20):
